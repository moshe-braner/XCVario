...
void DataMonitor::stop(){
	ESP_LOGI(FNAME,"stop");
	channel = MON_OFF;
	// the following line assumes that the pointer passed to start()
	// is really a pointer to an object of the derived class SetupMenuSelectCodes
	// even though it was generated by (*_action)( this ) in the base class
